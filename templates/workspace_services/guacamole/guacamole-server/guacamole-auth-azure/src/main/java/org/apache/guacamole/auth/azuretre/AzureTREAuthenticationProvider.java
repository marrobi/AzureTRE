...
public class AzureTREAuthenticationProvider extends AbstractAuthenticationProvider {
  ...
  public UserContext getUserContext(final AuthenticatedUser authenticatedUser) throws GuacamoleException {
    ...
    if (authenticatedUser instanceof AzureTREAuthenticatedUser) {
      ...
      var configs = ConnectionService.getConfigurations(user);

      LOGGER.debug("Creating user context.");
      final TreUserContext treUserContext = new TreUserContext(this, configs);
  ...
  public UserContext updateUserContext(UserContext context, AuthenticatedUser authenticatedUser, Credentials credentials) throws GuacamoleException {
    ...
    var ctx = getUserContext(authenticatedUser);
