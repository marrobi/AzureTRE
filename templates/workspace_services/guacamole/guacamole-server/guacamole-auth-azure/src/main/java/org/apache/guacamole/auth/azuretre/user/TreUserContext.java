...
import org.apache.guacamole.auth.azuretre.connection.TokenInjectingConnection;
...
public class TreUserContext extends AbstractUserContext {
  ...
  public TreUserContext(final AuthenticationProvider authProvider, Map<String, GuacamoleConfiguration> configs) {
    LOGGER.debug("Creating a new tre user context.");

    var connections = new ConcurrentHashMap(configs.size());
