...
make bundle-build DIR=templates/workspace_services/azureml/user_resources/aml_compute
make bundle-publish DIR=templates/workspace_services/azureml/user_resources/aml_compute
