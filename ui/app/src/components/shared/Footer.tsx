...
// GOV.UK crown SVG path data (Tudor crown)
const CROWN_PATH =
...
export const Footer: React.FunctionComponent = () => {
  ...
  return (
    <footer className="govuk-footer">
      <div className="govuk-width-container tre-footer-container">
        <svg
          focusable={false}
          role="presentation"
          aria-hidden={true}
        ...
        <div className="govuk-footer__meta">
          <div className="govuk-footer__meta-item govuk-footer__meta-item--grow">
            ...
            {(uiConfig.uiFooterText ?? "") !== "" && (
              <p className="govuk-body-s govuk-!-margin-top-2 govuk-!-margin-bottom-0">
                {uiConfig.uiFooterText}
              </p>
            )}
          </div>
          <div className="govuk-footer__meta-item tre-footer-info">
            <a
            ...
            <button
              className="tre-footer-info-button govuk-footer__link"
              id="info"
              onClick={() => setShowInfo(!showInfo)}
              aria-expanded={showInfo}
              aria-label={showInfo ? "Hide system information" : "Show system information"}
            >
              System info
            </button>
          </div>
