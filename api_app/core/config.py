...
SERVICE_BUS_EMULATOR_ENABLED: str = config("SERVICE_BUS_EMULATOR_ENABLED", default="false")

# Service bus emulator configuration
SERVICE_BUS_EMULATOR_IP_ADDRESS = config("SERVICE_BUS_EMULATOR_IP_ADDRESS", default="localhost")
SERVICE_BUS_EMULATOR_CONNECTION_STRING: str = config("SERVICE_BUS_EMULATOR_CONNECTION_STRING", default=f"Endpoint=sb://${SERVICE_BUS_EMULATOR_IP_ADDRESS}/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=SAS_KEY_VALUE;UseDevelopmentEmulator=true;")
