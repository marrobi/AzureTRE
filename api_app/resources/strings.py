...
WORKSPACE_SERVICE_TEMPLATE_NOT_ALLOWED_IN_WORKSPACE = "The workspace service template is not in the list of templates allowed to be deployed into this workspace"
WORKSPACE_SERVICE_TEMPLATE_VERSION_NOT_ALLOWED_IN_WORKSPACE = "The workspace service template version does not satisfy the version constraint allowed to be deployed into this workspace"
WORKSPACE_SERVICE_TEMPLATE_VERSION_CONSTRAINT_INVALID = "The workspace service template version constraint configured on the workspace is invalid"
