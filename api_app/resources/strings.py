...
API_REFRESH_COSTS = "Refresh collected cost data"
API_INGEST_COSTS = "Ingest cost data produced by a Cost Management export"
API_INGEST_COSTS_PERIOD_REQUIRED = "from_date and to_date are required when ingesting exported cost data"
API_INGEST_COSTS_TOO_MANY_ROWS = "too many cost rows in a single ingest request"
API_INGEST_COSTS_INTERNAL_SERVER_ERROR = "Failed to ingest exported Azure TRE costs."
API_INGEST_COSTS_TO_DATE_BEFORE_FROM_DATE = "to_date cannot be earlier than from_date"
API_GET_COST_SUBSCRIPTIONS = "Get the subscriptions TRE costs are incurred in"
API_GET_COST_SUBSCRIPTIONS_INTERNAL_SERVER_ERROR = "Failed to list Azure TRE cost subscriptions."
...
API_GET_COSTS_FROM_DATE_REQUIRED = "from_date is required when to_date is set"
API_GET_COSTS_TO_DATE_REQUIRED = "to_date is required when from_date is set"
